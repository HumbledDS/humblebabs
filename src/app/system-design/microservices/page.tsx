...
import { ArrowRight, Code2, Search, Filter, Sparkles } from "lucide-react"
...
import { microserviceArchitectures, microserviceCategories } from "@/lib/microservices-data"
...
export default function MicroservicesPage() {
  ...
  const filteredArchitectures = useMemo(() => {
    let filtered = microserviceArchitectures
  ...
  const allCategories = ["All", ...microserviceCategories]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Design patterns and best practices for building scalable microservices systems. 
              Explore architectural patterns that enable independent development and deployment.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                placeholder="Search microservices architectures..."
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore different architectural patterns for building scalable, resilient, and maintainable microservices systems.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredArchitectures.map((architecture, index) => (
                <ArchitectureCard
                  ...
                  href={`/system-design/microservices/${architecture.id}`}
                  index={index}
                />
              ))}
            </div>
