...
import { ArrowRight, Brain, Search, Filter, Sparkles } from "lucide-react"
...
import { aiMLArchitectures, aiMLCategories } from "@/lib/ai-ml-data"
...
export default function AIMLPage() {
  ...
  const filteredArchitectures = useMemo(() => {
    let filtered = aiMLArchitectures
  ...
  const allCategories = ["All", ...aiMLCategories]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Architectural patterns for machine learning systems and AI applications. 
              Explore MLOps, model serving, feature stores, and other critical components for production ML systems.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                placeholder="Search AI/ML architectures..."
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore different architectural patterns for building scalable, reliable, and efficient machine learning systems.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredArchitectures.map((architecture, index) => (
                <ArchitectureCard
                  ...
                  href={`/system-design/ai-ml/${architecture.id}`}
                  index={index}
                />
              ))}
            </div>
