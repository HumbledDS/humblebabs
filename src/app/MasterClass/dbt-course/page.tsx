...
export default function DBTCoursePage() {
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="text-4xl md:text-6xl font-bold mb-4">dbt</h1>
          <p className="text-muted-foreground mb-6">Modèles SQL, tests, documentation et déploiements pour des transformations fiables.</p>
